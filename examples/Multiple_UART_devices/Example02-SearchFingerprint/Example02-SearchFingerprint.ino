/*
  ...
  This example shows how to search if the fingertip scanned is found in the AS-108M/AD-013 flash memory.
...
void loop()
{
  // Search for any matching fingerprint
  AS108M_QUERY_DATA sd = as108m.searchFingerprint();
